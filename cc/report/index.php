                           ...
                           <div class="footer"></div>
                            ...
                            <div>
                                <div id="buttons"  align="center">
                                 <h2 align="left">Генерация отчета</h2>
                                    <button id="gray" class="btn btn-default" style="background-color: gray;color:white">Gray Box </button> 
                                    <button id="black" class="btn btn-default" style="background-color: black;color:white">Black Box</button><br><br><br><br><br><br>
                                </div>
                                <?php
                                if(file_exists('report.docx')){
                                    echo '<div align="center"><a href="report.docx"><img src="docx.png" "></a></div><br>
                                    ';
                                }
                                ?>
...
<script type="text/javascript">
    $("#gray").click(function () {
       $('#container').load('graybox.html');
       $("#buttons").hide();
    });
    $("#black").click(function () {
       $("#buttons").hide();
       $('#container').load('blackbox.html');
